...
import com.config.CommonUtil;
import com.config.ResourceFileUtil;
import com.config.ResultCount;
...
public class SendMailUtil {
	public Logger logger = Logger.getLogger(SendMailUtil.class);
	public static String username = CommonUtil.readConfig("mailconfig.properties", "username"); // 服务邮箱(from邮箱)
	public static String password = CommonUtil.readConfig("mailconfig.properties", "password"); // 邮箱密码
	public static String senderNick = CommonUtil.readConfig("mailconfig.properties", "senderNick");   // 发件人昵称
	...
	public SendMailUtil() {
		...
		props.put("mail.smtp.auth", CommonUtil.readConfig("mailconfig.properties", "smtp.auth"));
		props.put("mail.transport.protocol", CommonUtil.readConfig("mailconfig.properties", "transport.protocol"));
		props.put("mail.smtp.host", CommonUtil.readConfig("mailconfig.properties", "smtp.host"));
		props.put("mail.smtp.port", CommonUtil.readConfig("mailconfig.properties", "smtp.port"));
...
//          mimeMsg.setFrom(new InternetAddress(from));
	...
	public static void sendMail() {
		...
		fileList[0] = ResourceFileUtil.getResourcesPath("test-output")+"index.html";
		fileList[1] = ResourceFileUtil.getResourcesPath("log")+"AutoTest.log";
	...
	public static String getAutoMailTemplate() {
		...
		String startTime= CommonUtil.getRegularDate(Reporter.getCurrentTestResult().getTestContext().getStartDate());
		String endTime=CommonUtil.getRegularDate(Reporter.getCurrentTestResult().getTestContext().getEndDate());
