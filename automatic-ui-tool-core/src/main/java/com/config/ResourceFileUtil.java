...
public class ResourceFileUtil {
    ...
    public static String getResourcesPath(String folder){
        String s = ResourceFileUtil.class.getResource("/").toString();
        s=s.substring(6,s.length())+folder;
        return  s;
    }
    ...
    public static String setJsonBodyValue(String requestBodyFolder,String jsonfile, Object... parameters) {
        JSONObject addAnnounceRequestBody = new ResourceFileUtil().parseJsonFile(requestBodyFolder, jsonfile);
        addAnnounceRequestBody = setJsonBodyValue(addAnnounceRequestBody,parameters);
        return addAnnounceRequestBody.toJSONString();
    }
